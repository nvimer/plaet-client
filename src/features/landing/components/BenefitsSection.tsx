              ...
              >
                ...
                <ul className="space-y-6">
                  {step.benefits.map((benefit, bIndex) => (
                    ...
                    >
                      <div className="flex-shrink-0 w-8 h-8 rounded-2xl bg-primary-50 flex items-center justify-center group-hover/item:bg-primary-100 transition-colors">
                        <Check
                          className="w-5 h-5 text-primary-600"
                          strokeWidth={3}
                        />
                      </div>
                      <span className="text-xl text-carbon-800 font-medium group-hover/item:text-carbon-700 transition-colors">
                        {benefit}
                      </span>
                    </motion.li>
                  ))}
              ...
              >
                <div className="relative group/img">
                  ...
                  <motion.div 
                    ...
                    className="absolute -top-10 -bottom-10 -left-10 -right-10 bg-primary-50/50 rounded-5xl -z-10 border border-primary-100/50"
                  />
                  ...
                  >
                    <div className="flex items-center gap-5">
                      <div className="w-14 h-14 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center shadow-lg shadow-primary-200/50">
