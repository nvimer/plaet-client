  ...
  const statusOptions = [
    {
      ...
      icon: CircleCheck,
      selectedClass: "border-success-500 bg-success-50 ring-2 ring-success-500/20",
    ...
    },
    {
      ...
      icon: CircleDot,
      selectedClass: "border-error-500 bg-error-50 ring-2 ring-error-500/20",
    ...
    },
    {
      ...
      icon: Clock,
      selectedClass: "border-warning-500 bg-warning-50 ring-2 ring-warning-500/20",
