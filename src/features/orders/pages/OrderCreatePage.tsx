...
export function OrderCreatePage() {
  ...
  // useOrderBuilder has a single, unconditional, fully-typed return
  // (UseOrderBuilderReturn) — it cannot return undefined or a partial
  // shape, so no runtime normalization is needed here.
