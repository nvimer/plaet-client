...
export function OrderCreatePage() {
  ...
  const orderBuilder = useMemo(() => {
    ...
    return {
      ...orderBuilderRaw,
      // Add explicit fallbacks for ALL setter functions to prevent undefined errors
      setSelectedOrderType: orderBuilderRaw.setSelectedOrderType || (() => {}),
      setSelectedTable: orderBuilderRaw.setSelectedTable || (() => {}),
      setTableOrders: orderBuilderRaw.setTableOrders || (() => {}),
      setCurrentOrderIndex: orderBuilderRaw.setCurrentOrderIndex || (() => {}),
      setBackdatedDate: orderBuilderRaw.setBackdatedDate || (() => {}),
      setIsHistoricalMode: orderBuilderRaw.setIsHistoricalMode || (() => {}),
      setShowSummaryModal: orderBuilderRaw.setShowSummaryModal || (() => {}),
      setShowDailyMenu: orderBuilderRaw.setShowDailyMenu || (() => {}),
      setOrderNotes: orderBuilderRaw.setOrderNotes || (() => {}),
      setSelectedProtein: orderBuilderRaw.setSelectedProtein || (() => {}),
      setSelectedSoup: orderBuilderRaw.setSelectedSoup || (() => {}),
      setSelectedPrinciple: orderBuilderRaw.setSelectedPrinciple || (() => {}),
      setSelectedSalad: orderBuilderRaw.setSelectedSalad || (() => {}),
      setSelectedDrink: orderBuilderRaw.setSelectedDrink || (() => {}),
      setSelectedExtra: orderBuilderRaw.setSelectedExtra || (() => {}),
      setSelectedRice: orderBuilderRaw.setSelectedRice || (() => {}),
      setReplacements: orderBuilderRaw.setReplacements || (() => {}),
      setLooseItems: orderBuilderRaw.setLooseItems || (() => {}),
      setValidationErrors: orderBuilderRaw.setValidationErrors || (() => {}),
      setTouchedFields: orderBuilderRaw.setTouchedFields || (() => {}),
      setCustomerName: orderBuilderRaw.setCustomerName || (() => {}),
      setCustomerPhone: orderBuilderRaw.setCustomerPhone || (() => {}),
      setCustomerPhone2: orderBuilderRaw.setCustomerPhone2 || (() => {}),
      setDeliveryAddress: orderBuilderRaw.setDeliveryAddress || (() => {}),
      setAddress2: orderBuilderRaw.setAddress2 || (() => {}),
